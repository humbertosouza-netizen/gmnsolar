...
export default function Document() {
  return (
    <Html lang="pt-BR">
      <Head>
        <meta name="application-name" content="GMN Solar" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="default" />
        <meta name="apple-mobile-web-app-title" content="GMN Solar" />
        <meta name="description" content="Soluções completas em energia solar para Agro, Comércio e Indústria em todo MS" />
